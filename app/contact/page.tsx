    ...
    <main className="w-full min-h-screen relative pt-[200px]">
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-16 py-24 text-white">
        ...
        <div className="absolute right-10 top-[30%] -translate-y-1/2 flex flex-col gap-4 text-white">
          <a href="https://x.com/SiliconRoadHQ" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hover:scale-110 transition-transform block">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.259 5.63 5.905-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="https://www.linkedin.com/company/siliconroadusa/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:scale-110 transition-transform block">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="relative z-10 w-full bg-[#44494f] px-16 py-24 flex flex-col items-center text-center">
        <p className="text-[13px] tracking-[4px] text-gray-300 mb-4">JOIN US</p>
        ...
        />
        <button className="bg-[#707070] hover:bg-[#6b7280] text-white text-[14px] px-6 py-3 transition rounded-md">
          Subscribe
        </button>
      </div>
